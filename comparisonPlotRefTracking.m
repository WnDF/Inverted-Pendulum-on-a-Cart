%% LQR vs MPC Tracking Comparison
clear; clc; close all;

%% Load position data
lqrData = load('lqrPositionComp.mat');
mpcData = load('mpcPositionComp.mat');
...
%% Load angle data
lqrData = load('lqrAngleComp.mat');
mpcData = load('mpcAngleComp.mat');
...
xlabel('Time [s]')
ylabel('Angle [rad]')
title('Angle Tracking Comparison')
legend('Reference','LQR','MPC','Location','best')